...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*TopologyAwareScheduling)(nil), (*v1beta2.TopologyAwareScheduling)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_TopologyAwareScheduling_To_v1beta2_TopologyAwareScheduling(a.(*TopologyAwareScheduling), b.(*v1beta2.TopologyAwareScheduling), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1beta2.TopologyAwareScheduling)(nil), (*TopologyAwareScheduling)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_TopologyAwareScheduling_To_v1beta1_TopologyAwareScheduling(a.(*v1beta2.TopologyAwareScheduling), b.(*TopologyAwareScheduling), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_Configuration_To_v1beta2_Configuration(in *Configuration, out *v1beta2.Configuration, s conversion.Scope) error {
	...
	out.TopologyAwareScheduling = (*v1beta2.TopologyAwareScheduling)(unsafe.Pointer(in.TopologyAwareScheduling))
	return nil
}
...
func autoConvert_v1beta2_Configuration_To_v1beta1_Configuration(in *v1beta2.Configuration, out *Configuration, s conversion.Scope) error {
	...
	out.TopologyAwareScheduling = (*TopologyAwareScheduling)(unsafe.Pointer(in.TopologyAwareScheduling))
	return nil
}
...
func autoConvert_v1beta1_TopologyAwareScheduling_To_v1beta2_TopologyAwareScheduling(in *TopologyAwareScheduling, out *v1beta2.TopologyAwareScheduling, s conversion.Scope) error {
	out.NonTASPodsPriorityThreshold = (*int32)(unsafe.Pointer(in.NonTASPodsPriorityThreshold))
	return nil
}

// Convert_v1beta1_TopologyAwareScheduling_To_v1beta2_TopologyAwareScheduling is an autogenerated conversion function.
func Convert_v1beta1_TopologyAwareScheduling_To_v1beta2_TopologyAwareScheduling(in *TopologyAwareScheduling, out *v1beta2.TopologyAwareScheduling, s conversion.Scope) error {
	return autoConvert_v1beta1_TopologyAwareScheduling_To_v1beta2_TopologyAwareScheduling(in, out, s)
}

func autoConvert_v1beta2_TopologyAwareScheduling_To_v1beta1_TopologyAwareScheduling(in *v1beta2.TopologyAwareScheduling, out *TopologyAwareScheduling, s conversion.Scope) error {
	out.NonTASPodsPriorityThreshold = (*int32)(unsafe.Pointer(in.NonTASPodsPriorityThreshold))
	return nil
}

// Convert_v1beta2_TopologyAwareScheduling_To_v1beta1_TopologyAwareScheduling is an autogenerated conversion function.
func Convert_v1beta2_TopologyAwareScheduling_To_v1beta1_TopologyAwareScheduling(in *v1beta2.TopologyAwareScheduling, out *TopologyAwareScheduling, s conversion.Scope) error {
	return autoConvert_v1beta2_TopologyAwareScheduling_To_v1beta1_TopologyAwareScheduling(in, out, s)
}
